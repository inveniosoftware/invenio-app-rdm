...
import { DepositTextField } from './deposit-components';
...
class DepositAPI {
  ...
  save(deposit_payload) {
    console.log("PUT /api/records/:id/");
    return new Promise((resolve, reject) => {
      return resolve(deposit_payload); // return it back for now.
    });
  }

  publish() {
    console.log("POST /api/records/:id/");
  }
}
